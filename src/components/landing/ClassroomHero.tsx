...
const ClassroomHero = () => {
  ...
  useEffect(() => {
    ...
    const chairMat = new THREE.MeshStandardMaterial({ color: 0x2a2f3d, roughness: 0.62, metalness: 0.12 });
    const chairEdgeMat = new THREE.MeshStandardMaterial({ color: 0x1c2028, roughness: 0.55, metalness: 0.22 });
